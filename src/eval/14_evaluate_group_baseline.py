...
METRICS_OUT = Path("reports/metrics_logreg_group_baseline_v1.txt")
FIG_OUT = Path("reports/figures/confusion_matrix_logreg_group_baseline_v1.png")
...
def main():
    ...
    print("=== Logistic Regression GROUP Baseline (v1) ===")
    ...
    with open(METRICS_OUT, "w", encoding="utf-8") as f:
        f.write("Logistic Regression GROUP Baseline (v1)\n")
    ...
    plt.figure()
    plt.imshow(cm)
    plt.title("Confusion Matrix - LogReg GROUP Baseline v1")
